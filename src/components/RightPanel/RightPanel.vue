<template>
	<!-- Esse bind que estamos dando no class vai atribuir a classe 'open' para a nossa div
	sempre que a variável 'isOpen' for verdadeira, e retirar quando for falsa -->
...
<style lang="scss" scoped>
	...
	.panel{
		...
		&.open{
			.panel--front,
			.panel--back{
				//isso dar o efeito de livro abrindo
