...
<style lang="scss" scoped>
	.panel{
		position: absolute;
		width: 100%;
		/*Essa função de polygon serve para desenhar polígonos na tela, basicamente você diz os pontos no plano carteriano
		e a função vai ligando esses pontos até montar uma imagem */
